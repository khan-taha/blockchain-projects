...
contract MyEpicNFT is ERC721URIStorage {
    ...
    string[] firstWords = ["Red", "Yellow", "Blue", "Green", "Black", "Pink"];
    string[] secondWords = [
        "Charger",
        "Mobile",
        "Pen",
    ...
    function makeAnEpicNFT(string memory ipfsHash) public {
        ...
        //not more than 50 nfts can be minted
        require(
            newItemId < 50,
            "Sorry... The contract can only mint 50 NFTs"
        );
        ...
        _setTokenURI(newItemId, string(abi.encodePacked("ipfs://", ipfsHash)));
